...
- On `prompt_done` arrival: write a prompt snapshot under `session-history/<project-key>/<session-id>/prompts/p000001.json`, save final prompt metadata, then publish the `prompt_done` turn.
