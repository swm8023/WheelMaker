...
Current implementation baseline handles assistant/reasoning text deltas, `turn/started`, matching `turn/completed`, and thread name updates. Tool, plan, usage, and config notification rows below are follow-up mappings.
