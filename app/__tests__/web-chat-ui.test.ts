...
describe('web chat integration', () => {
  ...
  test('chat drawer header keeps tools left and hub browser right', () => {
    ...
    expect(mobileChatHeaderBlock).toContain('height: calc(var(--wm-safe-area-top) + 58px);');
    expect(mobileChatHeaderBlock).toContain('min-height: calc(var(--wm-safe-area-top) + 58px);');
    expect(mobileChatHeaderBlock).toContain('max-height: calc(var(--wm-safe-area-top) + 58px);');
    const mobileChatHeaderSearchOpenBlock = stylesCss.match(/\.mobile-chat-drawer-header\.search-open \{[\s\S]*?\n\}/)?.[0] ?? '';
    expect(mobileChatHeaderSearchOpenBlock).toContain('height: calc(var(--wm-safe-area-top) + 58px);');
    expect(mobileChatHeaderSearchOpenBlock).toContain('min-height: calc(var(--wm-safe-area-top) + 58px);');
    expect(mobileChatHeaderSearchOpenBlock).toContain('max-height: calc(var(--wm-safe-area-top) + 58px);');
    ...
    expect(mobileSearchWrapBlock).toContain('height: 40px;');
    ...
    expect(mobileSearchStatusBlock).toContain('bottom: -3px;');
