...
// ConsoleIM implements im.Adapter for local testing via stdin/stdout.
...
func (c *ConsoleIM) Run(ctx context.Context) error {
	fmt.Fprintf(os.Stderr, "[%s] ready. Type a message or /status, /use <provider>, /cancel. Ctrl+C to quit.\n", c.projectName)
...
var _ im.Adapter = (*ConsoleIM)(nil)
